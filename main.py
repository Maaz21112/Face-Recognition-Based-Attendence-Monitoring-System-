...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'face_recognition@gmail.com' ")
...
menubar.add_cascade(label='Change Password',font=('comic', 29, ' bold '), command = change_pass)
menubar.add_cascade(label='View Attendance',font=('comic', 29, ' bold '))
